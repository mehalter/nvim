...
Plug 'https://github.com/aklt/plantuml-syntax', Cond(!exists('g:vscode')) " REMOVE ONCE TREESITTER CATCHES UP
...
Plug 'https://github.com/vim-pandoc/vim-pandoc', Cond(!exists('g:vscode')) " REMOVE ONCE TREESITTER CATCHES UP
Plug 'https://github.com/vim-pandoc/vim-pandoc-syntax', Cond(!exists('g:vscode')) " REMOVE ONCE TREESITTER CATCHES UP
Plug 'https://github.com/vim-pandoc/vim-rmarkdown', Cond(!exists('g:vscode')) " REMOVE ONCE TREESITTER CATCHES UP
